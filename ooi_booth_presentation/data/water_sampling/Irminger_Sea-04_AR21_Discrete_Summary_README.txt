...
CTD data copied to the new row. The first row of the file is the column headers. <br>
  ...
  | --------------- | --------------- | ------- |
  | 7 | 12 | Niskin did not fire. |
  | 8 | 3 | Niskin did not fire. |
...
### Chlorophyll and Phaeo<br>
  ...
  | Station-Cast #  | Bottle Position | Comment |
  | --------------- | --------------- | ------- |
  | 7 | 6 | extreme phaeo:chl ratio but deep depth so makes sense |
  | 10 | 12 | recorded in OOI data as 9/01 but on cast 10? Recorded on tissue capsule as 10/01 |
